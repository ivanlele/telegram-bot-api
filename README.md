...
[![Go Reference](https://pkg.go.dev/badge/github.com/ivanlele/telegram-bot-api/v5.svg)](https://pkg.go.dev/github.com/ivanlele/telegram-bot-api/v5)
...
All methods are fairly self-explanatory, and reading the [godoc](https://pkg.go.dev/github.com/ivanlele/telegram-bot-api/v5) page should
...
`go get -u github.com/ivanlele/telegram-bot-api/v5`.
...
import (
	...
	tgbotapi "github.com/ivanlele/telegram-bot-api/v5"
)
...
import (
	...
	"github.com/ivanlele/telegram-bot-api/v5"
)
